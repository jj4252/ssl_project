...
class VICRegTransform:
    """
    VICReg-style augmentation for contrastive learning.
    Returns two independently augmented views per image with strong augmentations.
    """
    def __init__(self, image_size=96):
        # Base transform with strong augmentations
